...
export const paths = {
  ...
  cart : '/cart',
  menu: (restaurant_id: string) => `/${restaurant_id}/menu`,
  order : '/order',
  ...
  auth: {
    ...
    jwt: {
      ...
      loginRedirect: (returnTo: string) => `${ROOTS.AUTH}/jwt/login?returnTo=${encodeURIComponent(returnTo)}`,
      registerRedirect:(returnTo: string) => `${ROOTS.AUTH}/jwt/register?returnTo=${encodeURIComponent(returnTo)}`,
